...
module mo_rrtmgp_gas_optics
  ...
  ! -------------------------------------------------------------------------------------------------
  type, extends(ty_gas_optics), public :: ty_rrtmgp_gas_optics
    private
    !
  ...
  contains
    ...
    ! Public procedures - defined by base type
    ...
    ! Public procedures - RRTMGP-specific 
...
contains
  ...
  pure function get_ngas(this)
    ...
    class(ty_rrtmgp_gas_optics), intent(in) :: this
    integer                                        :: get_ngas
  ...
  function load_int(this, available_gases, gas_names, key_species,  &
    ...
    class(ty_rrtmgp_gas_optics),     intent(inout) :: this
...
! ---------------------------------------------------------------------------------------
 ...
 subroutine combine_and_reorder(tau, tau_rayleigh, has_rayleigh, optical_props)
  ...
  !------------------------------------------------------------------------------------------
end module mo_rrtmgp_gas_optics
